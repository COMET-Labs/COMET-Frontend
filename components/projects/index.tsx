            ...
            <div className={"row "+styles.project}>
              ...
              <div className="col-lg-8 col-md-6 col-sm-12">
                ...
                <div className={styles.all_icons}>
                  <a href={project.link}><span className={"iconify "+styles.icon} data-icon="mdi:web" color="black" data-inline="false"></span></a>
                  <a href={project.github}><span className={"iconify "+styles.icon} data-icon="entypo:code" color="black" data-inline="false"></span></a>
              </div>
              </div>
            </div>
          </div>
